...
It is currently based on version [6.3.4 of the packbackbooks/lti-1-3-php-library](https://github.com/packbackbooks/lti-1-3-php-library/releases/tag/v6.3.4) library.
...
The following changes are included so that the library may be used with Moodle:
  ...
  * Fix allowing optional lineitem properties to be omitted in deep linking response
